...
N.B.: The orientation map in the code is the reduced version of the full orientation map, including duplicates:
```python
orientation_map = [
    [" x"," y"," z"], # 0, 0, 0
    [" y","-x"," z"], # 0, 0, 90
...
Full set of translations, including mirrors:
```python
orientation_map = [
    ...
    [pm["-z"],pm["-y"],pm[" x"]], # Non Rotation
    [pm[" y"],pm["-z"],pm[" x"]], # Non Rotation
    [pm[" z"],pm[" y"],pm[" x"]], # Non Rotation
    [pm["-y"],pm[" z"],pm[" x"]], # Non Rotation
    ...
    [pm["-x"],pm["-z"],pm[" y"]], # Non Rotation
    [pm[" z"],pm["-x"],pm[" y"]], # Non Rotation
    [pm[" x"],pm[" z"],pm[" y"]], # Non Rotation
    [pm["-z"],pm[" x"],pm[" y"]], # Non Rotation
    ...
    [pm["-x"],pm[" y"],pm[" z"]], # Non Rotation
    [pm["-y"],pm["-x"],pm[" z"]], # Non Rotation
    [pm[" x"],pm["-y"],pm[" z"]], # Non Rotation
    [pm[" y"],pm[" x"],pm[" z"]], # Non Rotation
